...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.getElementById("vimeo-player"),ep=new Q(eh),ev=e=>{localStorage.setItem("videoplayer-current-time",e)},ey=()=>{let e=localStorage.getItem("videoplayer-current-time");e&&ep.setCurrentTime(parseFloat(e))};ep.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(e=>{let t=e.seconds;ev(t)},1e3)),window.addEventListener("load",()=>{ey()});//# sourceMappingURL=02-video.85c1f466.js.map

//# sourceMappingURL=02-video.85c1f466.js.map
